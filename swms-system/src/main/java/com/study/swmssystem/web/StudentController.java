...
public class StudentController {
    ...
    public String submithomework(Model m, HttpServletRequest request, @RequestParam(value = "course") String courseid, @RequestParam(value = "answer") String answer)throws Exception{
        Answer myanswer = new Answer();
        myanswer.setAnswer(answer);
        Course course = courseDAO.getOne(Integer.parseInt(courseid));
        //myanswer.setCourse(course);
